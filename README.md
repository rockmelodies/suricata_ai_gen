...
- **前端应用**：http://localhost:5173 (或 http://YOUR_IP:5173)
...
cd frontend-vue3
npm install  # 首次运行
npm run dev  # 支持所有网卡访问
```

前端将运行在 `http://0.0.0.0:5173` (可通过 `http://YOUR_IP:5173` 访问)
...
- **前端应用**: `http://localhost:5173` (或 `http://YOUR_IP:5173`)
- **后端API**: `http://localhost:5000/api` (或 `http://YOUR_IP:5000/api`)
